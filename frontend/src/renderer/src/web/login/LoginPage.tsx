...
// Composes LoginForm + SsoButton list.
// FIX CR-FE2E-002: PairCodeFallback removed — this page only renders while
// sessionUser === null (main-web-bootstrap.tsx), i.e. the multi-user backend
// path where local/SSO login is always available; E2EE pairing has no valid
// use here (kept intact for the separate Desktop Pair Code sharing path, see
// docs/crs/v2/frontend-e2ee/).
