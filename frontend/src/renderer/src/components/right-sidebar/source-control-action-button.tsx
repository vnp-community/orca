// `ActionButton`: the small icon-only Tooltip+Button used for row/section
// stage/unstage/discard actions throughout the Source Control panel.
// Extracted verbatim from SourceControl.tsx (TASK-BIGFILE-025).
