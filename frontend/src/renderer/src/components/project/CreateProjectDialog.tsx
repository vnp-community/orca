...
export function CreateProjectDialog({ open, onOpenChange, onCreated }: CreateProjectDialogProps) {
  ...
  function findDuplicateRepo(path: string, targetDevServerId: string) {
    ...
    if (!normalizedPath || !targetDevServerId) {return undefined}
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      await callRuntimeRpc(target, 'project.rebindDevServer', {
        ...
        toast.error('Project created, but the dev server could not be bound. Set it from Project Settings.')
      })
      await callRuntimeRpc(target, 'repo.add', {
        ...
        toast.error('Project created, but the repo could not be added. Add it from Project Settings.')
      })
