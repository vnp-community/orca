...
// 'notification'/'webhook'/'condition' match backend StepType (step.go:16-23) exactly.
// 'approval' has no backend equivalent and is kept only pending product confirmation on
// whether to drop it outright or map it to orchestration-service's DecisionGate instead —
// see FE-TASK-004 (workflow v4)'s "Cần xác nhận sản phẩm" note. Do not remove without that.
