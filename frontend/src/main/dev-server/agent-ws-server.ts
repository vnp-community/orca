...
export class AgentWebSocketServer {
  ...
  registerSlot(
    ...
    const expireTimer = setTimeout(() => {
      ...
      // FIX TASK-FE-HLD-004: read the configured HTTP port instead of a literal
      // '6768' so the instructions stay correct when ORCA_HTTP_PORT is overridden.
      ...
      onExpired(
        `direct-websocket: Agent did not connect within ${AGENT_CONNECT_TIMEOUT_MS / 1000}s. ` +
          ...
          `  ORCA_URL=ws://<orca-host>:${port}${AGENT_WS_PATH}\n` +
