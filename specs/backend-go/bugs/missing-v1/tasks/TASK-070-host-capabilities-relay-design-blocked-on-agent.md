...
**Status:** `[ ]` TODO — **DO NOT START.** This task exists only to record the target contract for a future pass; there is no buildable work here until `agent/` gains a host-capability-probing method.
