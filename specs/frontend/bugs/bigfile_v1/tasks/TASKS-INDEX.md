...
| 83 | [TASK-BIGFILE-083](./TASK-BIGFILE-083-forward-methods-pilot.md) | Kỹ thuật mới — pilot `forwardMethods`, giảm boilerplate wiring | `orca-runtime.ts` (nội bộ, domain `issueTrackingCommands`) | L | — | ✅ (pilot) |
