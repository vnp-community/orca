...
- This page and the separate "Project Workspace (Beta)" page (`activeView === 'workspace'`) are two independent, non-overlapping implementations of worktree/git/file UI — the Beta page is additive-only and does not replace this flow (see `docs/guides/project-workspace-f38-doc-vs-code.md`).
