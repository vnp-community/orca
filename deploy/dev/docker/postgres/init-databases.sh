...
# Only the 14 services that own a database are listed here — see
# specs/backend-go/services/00-service-catalog.md for which 3 don't.
...
DATABASES="auth tenant project infra aiprovider workflow task orchestration automation annotation notification usage credential issuetracking"
