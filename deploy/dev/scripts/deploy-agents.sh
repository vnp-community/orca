...
#
# Usage:
#   bash deploy/dev/scripts/deploy-agents.sh                  # deploy tất cả
#   bash deploy/dev/scripts/deploy-agents.sh --server DEV01  # 1 server
#   bash deploy/dev/scripts/deploy-agents.sh --list           # liệt kê
#   bash deploy/dev/scripts/deploy-agents.sh --status         # kiểm tra
#   bash deploy/dev/scripts/deploy-agents.sh --stop           # dừng tất cả
#   bash deploy/dev/scripts/deploy-agents.sh --logs DEV01    # xem logs
#   bash deploy/dev/scripts/deploy-agents.sh --build          # build agent.js
#   bash deploy/dev/scripts/deploy-agents.sh --help
# ============================================================
...
AGENT_JS_PATH="${REPO_ROOT}/out/relay/agent.js"
...
do_build_agent() {
    ...
    log "Chạy: node config/scripts/build-agent-only.mjs"
    (cd "${REPO_ROOT}" && node config/scripts/build-agent-only.mjs) \
