...
#
# Usage:
#   bash deploy/agent/scripts/connect-agent.sh                    # direct-ws (default)
#   bash deploy/agent/scripts/connect-agent.sh --mode relay-ws   # relay-ws mode
#   bash deploy/agent/scripts/connect-agent.sh --deploy          # deploy agent trước rồi connect
#   bash deploy/agent/scripts/connect-agent.sh --start           # chỉ khởi động agent đã deploy
#   bash deploy/agent/scripts/connect-agent.sh --status          # kiểm tra agent status
#   bash deploy/agent/scripts/connect-agent.sh --stop            # dừng agent
#   bash deploy/agent/scripts/connect-agent.sh --logs            # xem logs agent
#   bash deploy/agent/scripts/connect-agent.sh --help
# =================================================================
...
print_help() {
    ...
    echo "  bash deploy/agent/scripts/connect-agent.sh [mode] [action]"
    echo ""
