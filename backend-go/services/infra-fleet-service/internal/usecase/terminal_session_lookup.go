...
func resolveTerminalSession(ctx context.Context, tenantID, ptyID string, sessions TerminalSessionRepository, resolver ConnectionResolver) (domain.TerminalSession, domain.DevServer, error) {
