...
func TestPickByTag_PicksFirstConnectedGroupMember(t *testing.T) {
	...
	dsDisconnected, _ := domain.NewDevServer("ds-1", "tenant-1", "10.0.0.1", domain.ConnectionModeDirectWebSocket, "", nil)
	dsDisconnected.GroupID = "grp-1"
	dsConnected, _ := domain.NewDevServer("ds-2", "tenant-1", "10.0.0.2", domain.ConnectionModeDirectWebSocket, "", nil)
	dsConnected.GroupID = "grp-1"
	dsOtherGroup, _ := domain.NewDevServer("ds-3", "tenant-1", "10.0.0.3", domain.ConnectionModeDirectWebSocket, "", nil)
