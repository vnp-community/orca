...
func TestSpawnAgent_SendsExpectedParamsAndDecodesResult(t *testing.T) {
	...
	devServer, err := domain.NewDevServer("ds-agent-1", "tenant-1", host, domain.ConnectionModeRelayWebSocket, "")
	if err != nil {
...
func TestSpawnAgent_MissingPtyIDInResponse_ReturnsError(t *testing.T) {
	...
	devServer, err := domain.NewDevServer("ds-agent-missing", "tenant-1", host, domain.ConnectionModeRelayWebSocket, "")
	if err != nil {
		t.Fatalf("NewDevServer: %v", err)
	}
...
func TestKillAgent_SendsExpectedParamsAndDefaultsSignal(t *testing.T) {
	...
	devServer, err := domain.NewDevServer("ds-agent-kill", "tenant-1", host, domain.ConnectionModeRelayWebSocket, "")
	if err != nil {
		t.Fatalf("NewDevServer: %v", err)
	}
...
func TestSendAgentInput_SendsExpectedParams(t *testing.T) {
	...
	devServer, err := domain.NewDevServer("ds-agent-input", "tenant-1", host, domain.ConnectionModeRelayWebSocket, "")
	if err != nil {
		t.Fatalf("NewDevServer: %v", err)
	}
...
func TestStreamAgentHooks_DecodesAndDeliversProviderSession(t *testing.T) {
	...
	devServer, err := domain.NewDevServer("ds-agent-hooks", "tenant-1", host, domain.ConnectionModeRelayWebSocket, "")
	if err != nil {
		t.Fatalf("NewDevServer: %v", err)
	}
