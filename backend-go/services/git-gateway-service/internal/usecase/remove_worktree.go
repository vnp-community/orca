...
func NewRemoveWorktree(resolver ConnectionResolver, projects ProjectClient, scrollback ScrollbackCleaner, scm SCMClient, local, relay GitExecutor) *RemoveWorktree {
	return &RemoveWorktree{resolver: resolver, projects: projects, scrollback: scrollback, scm: scm, local: local, relay: relay}
}
