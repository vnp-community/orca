...
func (fakeProjectClient) RecordWorktreeCreated(_ context.Context, _, repoID, path, branch, _ string, _ domain.WorktreeLineageCapture) (domain.WorktreeRecord, error) {
