...
func TestRepository_CreateAndListAnnotations_FiltersByTenant(t *testing.T) {
	...
	a1, err := domain.NewAnnotation("11111111-1111-1111-1111-111111111111", "22222222-2222-2222-2222-222222222222", "33333333-3333-3333-3333-333333333333", anchor1, "comment 1", false, now, now)
	if err != nil {
	...
	a2, err := domain.NewAnnotation("44444444-4444-4444-4444-444444444444", "55555555-5555-5555-5555-555555555555", "33333333-3333-3333-3333-333333333333", anchor2, "comment 2", false, now, now)
	if err != nil {
		t.Fatalf("building annotation: %v", err)
	}
