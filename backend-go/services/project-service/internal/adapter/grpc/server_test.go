...
func (f *fakeWorktreeRepository) ListWorktrees(context.Context, string, []string, *time.Time) ([]domain.Worktree, error) {
	return nil, nil
}
func (f *fakeWorktreeRepository) FindWorktreeByIdempotencyKey(context.Context, string, string) (domain.Worktree, bool, error) {
	return domain.Worktree{}, false, nil
}
func (f *fakeWorktreeRepository) CreateWorktreeWithEvent(context.Context, domain.Worktree, domain.OutboxEvent) (domain.Worktree, error) {
	return domain.Worktree{}, nil
}
func (f *fakeWorktreeRepository) RemoveWorktreeWithEvent(context.Context, string, func(domain.Worktree) domain.OutboxEvent) error {
	return nil
}
