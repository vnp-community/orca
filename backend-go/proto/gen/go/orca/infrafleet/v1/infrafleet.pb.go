...
const file_orca_infrafleet_v1_infrafleet_proto_rawDesc = "" +
	...
	" CONNECTION_MODE_DIRECT_WEBSOCKET\x10\x032\xac\x1f\n" +
	...
	"\x16InspectTerminalProcess\x121.orca.infrafleet.v1.InspectTerminalProcessRequest\x1a2.orca.infrafleet.v1.InspectTerminalProcessResponse\x12\x82\x01\n" +
...
var file_orca_infrafleet_v1_infrafleet_proto_msgTypes = make([]protoimpl.MessageInfo, 74)
var file_orca_infrafleet_v1_infrafleet_proto_goTypes = []any{
	...
	(*GetAgentTerminalSessionRequest)(nil),  // 41: orca.infrafleet.v1.GetAgentTerminalSessionRequest
	(*GetAgentTerminalSessionResponse)(nil), // 42: orca.infrafleet.v1.GetAgentTerminalSessionResponse
	(*SendTerminalInputRequest)(nil),        // 43: orca.infrafleet.v1.SendTerminalInputRequest
	(*GetTerminalScrollbackRequest)(nil),    // 44: orca.infrafleet.v1.GetTerminalScrollbackRequest
	(*GetTerminalScrollbackResponse)(nil),   // 45: orca.infrafleet.v1.GetTerminalScrollbackResponse
	(*InspectTerminalProcessRequest)(nil),   // 46: orca.infrafleet.v1.InspectTerminalProcessRequest
	(*InspectTerminalProcessResponse)(nil),  // 47: orca.infrafleet.v1.InspectTerminalProcessResponse
	(*PtyClientFrame)(nil),                  // 48: orca.infrafleet.v1.PtyClientFrame
	(*AttachToSession)(nil),                 // 49: orca.infrafleet.v1.AttachToSession
	(*PtyInput)(nil),                        // 50: orca.infrafleet.v1.PtyInput
	(*PtyResize)(nil),                       // 51: orca.infrafleet.v1.PtyResize
	(*PtyServerFrame)(nil),                  // 52: orca.infrafleet.v1.PtyServerFrame
	(*PtyOutput)(nil),                       // 53: orca.infrafleet.v1.PtyOutput
	(*PtyExited)(nil),                       // 54: orca.infrafleet.v1.PtyExited
	(*BrowserProfile)(nil),                  // 55: orca.infrafleet.v1.BrowserProfile
	(*ListBrowserProfilesRequest)(nil),      // 56: orca.infrafleet.v1.ListBrowserProfilesRequest
	(*ListBrowserProfilesResponse)(nil),     // 57: orca.infrafleet.v1.ListBrowserProfilesResponse
	(*CreateBrowserProfileRequest)(nil),     // 58: orca.infrafleet.v1.CreateBrowserProfileRequest
	(*CreateBrowserProfileResponse)(nil),    // 59: orca.infrafleet.v1.CreateBrowserProfileResponse
	(*DeleteBrowserProfileRequest)(nil),     // 60: orca.infrafleet.v1.DeleteBrowserProfileRequest
	(*EmulatorDevice)(nil),                  // 61: orca.infrafleet.v1.EmulatorDevice
	(*ListEmulatorDevicesRequest)(nil),      // 62: orca.infrafleet.v1.ListEmulatorDevicesRequest
	(*ListEmulatorDevicesResponse)(nil),     // 63: orca.infrafleet.v1.ListEmulatorDevicesResponse
	(*GetEmulatorAvailabilityRequest)(nil),  // 64: orca.infrafleet.v1.GetEmulatorAvailabilityRequest
	(*GetEmulatorAvailabilityResponse)(nil), // 65: orca.infrafleet.v1.GetEmulatorAvailabilityResponse
	(*EmulatorSession)(nil),                 // 66: orca.infrafleet.v1.EmulatorSession
	(*AttachEmulatorSessionRequest)(nil),    // 67: orca.infrafleet.v1.AttachEmulatorSessionRequest
	(*SendEmulatorTapRequest)(nil),          // 68: orca.infrafleet.v1.SendEmulatorTapRequest
	(*SendEmulatorGestureRequest)(nil),      // 69: orca.infrafleet.v1.SendEmulatorGestureRequest
	(*SendEmulatorButtonRequest)(nil),       // 70: orca.infrafleet.v1.SendEmulatorButtonRequest
	(*RotateEmulatorRequest)(nil),           // 71: orca.infrafleet.v1.RotateEmulatorRequest
	(*ShutdownEmulatorRequest)(nil),         // 72: orca.infrafleet.v1.ShutdownEmulatorRequest
	(*GetHostCapabilitiesRequest)(nil),      // 73: orca.infrafleet.v1.GetHostCapabilitiesRequest
	(*GetHostCapabilitiesResponse)(nil),     // 74: orca.infrafleet.v1.GetHostCapabilitiesResponse
...
var file_orca_infrafleet_v1_infrafleet_proto_depIdxs = []int32{
	...
	49, // 10: orca.infrafleet.v1.PtyClientFrame.attach:type_name -> orca.infrafleet.v1.AttachToSession
	50, // 11: orca.infrafleet.v1.PtyClientFrame.input:type_name -> orca.infrafleet.v1.PtyInput
	51, // 12: orca.infrafleet.v1.PtyClientFrame.resize:type_name -> orca.infrafleet.v1.PtyResize
	53, // 13: orca.infrafleet.v1.PtyServerFrame.out:type_name -> orca.infrafleet.v1.PtyOutput
	54, // 14: orca.infrafleet.v1.PtyServerFrame.exited:type_name -> orca.infrafleet.v1.PtyExited
	75, // 15: orca.infrafleet.v1.BrowserProfile.created_at:type_name -> google.protobuf.Timestamp
	55, // 16: orca.infrafleet.v1.ListBrowserProfilesResponse.profiles:type_name -> orca.infrafleet.v1.BrowserProfile
	55, // 17: orca.infrafleet.v1.CreateBrowserProfileResponse.profile:type_name -> orca.infrafleet.v1.BrowserProfile
	61, // 18: orca.infrafleet.v1.ListEmulatorDevicesResponse.devices:type_name -> orca.infrafleet.v1.EmulatorDevice
	...
	31, // 32: orca.infrafleet.v1.InfraFleetService.ResizeTerminalSession:input_type -> orca.infrafleet.v1.ResizeTerminalSessionRequest
	32, // 33: orca.infrafleet.v1.InfraFleetService.KillTerminalSession:input_type -> orca.infrafleet.v1.KillTerminalSessionRequest
	33, // 34: orca.infrafleet.v1.InfraFleetService.StopTerminalProcess:input_type -> orca.infrafleet.v1.StopTerminalProcessRequest
	34, // 35: orca.infrafleet.v1.InfraFleetService.ListTerminalSessions:input_type -> orca.infrafleet.v1.ListTerminalSessionsRequest
	36, // 36: orca.infrafleet.v1.InfraFleetService.WaitTerminalSession:input_type -> orca.infrafleet.v1.WaitTerminalSessionRequest
	38, // 37: orca.infrafleet.v1.InfraFleetService.FocusTerminalSession:input_type -> orca.infrafleet.v1.FocusTerminalSessionRequest
	39, // 38: orca.infrafleet.v1.InfraFleetService.GetTerminalAgentStatus:input_type -> orca.infrafleet.v1.GetTerminalAgentStatusRequest
	46, // 39: orca.infrafleet.v1.InfraFleetService.InspectTerminalProcess:input_type -> orca.infrafleet.v1.InspectTerminalProcessRequest
	41, // 40: orca.infrafleet.v1.InfraFleetService.GetAgentTerminalSession:input_type -> orca.infrafleet.v1.GetAgentTerminalSessionRequest
	43, // 41: orca.infrafleet.v1.InfraFleetService.SendTerminalInput:input_type -> orca.infrafleet.v1.SendTerminalInputRequest
	44, // 42: orca.infrafleet.v1.InfraFleetService.GetTerminalScrollback:input_type -> orca.infrafleet.v1.GetTerminalScrollbackRequest
	48, // 43: orca.infrafleet.v1.InfraFleetService.AttachPty:input_type -> orca.infrafleet.v1.PtyClientFrame
	56, // 44: orca.infrafleet.v1.InfraFleetService.ListBrowserProfiles:input_type -> orca.infrafleet.v1.ListBrowserProfilesRequest
	58, // 45: orca.infrafleet.v1.InfraFleetService.CreateBrowserProfile:input_type -> orca.infrafleet.v1.CreateBrowserProfileRequest
	60, // 46: orca.infrafleet.v1.InfraFleetService.DeleteBrowserProfile:input_type -> orca.infrafleet.v1.DeleteBrowserProfileRequest
	62, // 47: orca.infrafleet.v1.InfraFleetService.ListEmulatorDevices:input_type -> orca.infrafleet.v1.ListEmulatorDevicesRequest
	64, // 48: orca.infrafleet.v1.InfraFleetService.GetEmulatorAvailability:input_type -> orca.infrafleet.v1.GetEmulatorAvailabilityRequest
	67, // 49: orca.infrafleet.v1.InfraFleetService.AttachEmulatorSession:input_type -> orca.infrafleet.v1.AttachEmulatorSessionRequest
	68, // 50: orca.infrafleet.v1.InfraFleetService.SendEmulatorTap:input_type -> orca.infrafleet.v1.SendEmulatorTapRequest
	69, // 51: orca.infrafleet.v1.InfraFleetService.SendEmulatorGesture:input_type -> orca.infrafleet.v1.SendEmulatorGestureRequest
	70, // 52: orca.infrafleet.v1.InfraFleetService.SendEmulatorButton:input_type -> orca.infrafleet.v1.SendEmulatorButtonRequest
	71, // 53: orca.infrafleet.v1.InfraFleetService.RotateEmulator:input_type -> orca.infrafleet.v1.RotateEmulatorRequest
	72, // 54: orca.infrafleet.v1.InfraFleetService.ShutdownEmulator:input_type -> orca.infrafleet.v1.ShutdownEmulatorRequest
	73, // 55: orca.infrafleet.v1.InfraFleetService.GetHostCapabilities:input_type -> orca.infrafleet.v1.GetHostCapabilitiesRequest
	...
	29, // 68: orca.infrafleet.v1.InfraFleetService.SpawnTerminalSession:output_type -> orca.infrafleet.v1.SpawnTerminalSessionResponse
	76, // 69: orca.infrafleet.v1.InfraFleetService.ResizeTerminalSession:output_type -> google.protobuf.Empty
	76, // 70: orca.infrafleet.v1.InfraFleetService.KillTerminalSession:output_type -> google.protobuf.Empty
	76, // 71: orca.infrafleet.v1.InfraFleetService.StopTerminalProcess:output_type -> google.protobuf.Empty
	35, // 72: orca.infrafleet.v1.InfraFleetService.ListTerminalSessions:output_type -> orca.infrafleet.v1.ListTerminalSessionsResponse
	37, // 73: orca.infrafleet.v1.InfraFleetService.WaitTerminalSession:output_type -> orca.infrafleet.v1.WaitTerminalSessionResponse
	76, // 74: orca.infrafleet.v1.InfraFleetService.FocusTerminalSession:output_type -> google.protobuf.Empty
	40, // 75: orca.infrafleet.v1.InfraFleetService.GetTerminalAgentStatus:output_type -> orca.infrafleet.v1.GetTerminalAgentStatusResponse
	47, // 76: orca.infrafleet.v1.InfraFleetService.InspectTerminalProcess:output_type -> orca.infrafleet.v1.InspectTerminalProcessResponse
	42, // 77: orca.infrafleet.v1.InfraFleetService.GetAgentTerminalSession:output_type -> orca.infrafleet.v1.GetAgentTerminalSessionResponse
	76, // 78: orca.infrafleet.v1.InfraFleetService.SendTerminalInput:output_type -> google.protobuf.Empty
	45, // 79: orca.infrafleet.v1.InfraFleetService.GetTerminalScrollback:output_type -> orca.infrafleet.v1.GetTerminalScrollbackResponse
	52, // 80: orca.infrafleet.v1.InfraFleetService.AttachPty:output_type -> orca.infrafleet.v1.PtyServerFrame
	57, // 81: orca.infrafleet.v1.InfraFleetService.ListBrowserProfiles:output_type -> orca.infrafleet.v1.ListBrowserProfilesResponse
	59, // 82: orca.infrafleet.v1.InfraFleetService.CreateBrowserProfile:output_type -> orca.infrafleet.v1.CreateBrowserProfileResponse
	76, // 83: orca.infrafleet.v1.InfraFleetService.DeleteBrowserProfile:output_type -> google.protobuf.Empty
	63, // 84: orca.infrafleet.v1.InfraFleetService.ListEmulatorDevices:output_type -> orca.infrafleet.v1.ListEmulatorDevicesResponse
	65, // 85: orca.infrafleet.v1.InfraFleetService.GetEmulatorAvailability:output_type -> orca.infrafleet.v1.GetEmulatorAvailabilityResponse
	66, // 86: orca.infrafleet.v1.InfraFleetService.AttachEmulatorSession:output_type -> orca.infrafleet.v1.EmulatorSession
	76, // 87: orca.infrafleet.v1.InfraFleetService.SendEmulatorTap:output_type -> google.protobuf.Empty
	76, // 88: orca.infrafleet.v1.InfraFleetService.SendEmulatorGesture:output_type -> google.protobuf.Empty
	76, // 89: orca.infrafleet.v1.InfraFleetService.SendEmulatorButton:output_type -> google.protobuf.Empty
	76, // 90: orca.infrafleet.v1.InfraFleetService.RotateEmulator:output_type -> google.protobuf.Empty
	76, // 91: orca.infrafleet.v1.InfraFleetService.ShutdownEmulator:output_type -> google.protobuf.Empty
	74, // 92: orca.infrafleet.v1.InfraFleetService.GetHostCapabilities:output_type -> orca.infrafleet.v1.GetHostCapabilitiesResponse
