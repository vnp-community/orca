...
func (BulkProvisionFleetEvent_Status) EnumDescriptor() ([]byte, []int) {
	return file_orca_infrafleet_v1_infrafleet_proto_rawDescGZIP(), []int{66, 0}
}
...
type PickByTagRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// tenant_id intentionally absent — pulled from context, same convention
	// as ListDevServerGroupsRequest.
	Tag           string `protobuf:"bytes,1,opt,name=tag,proto3" json:"tag,omitempty"` // matches a DevServerGroup.name
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PickByTagRequest) Reset() {
	*x = PickByTagRequest{}
...
func (x *PickByTagRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PickByTagRequest) ProtoMessage() {}

func (x *PickByTagRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orca_infrafleet_v1_infrafleet_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PickByTagRequest.ProtoReflect.Descriptor instead.
func (*PickByTagRequest) Descriptor() ([]byte, []int) {
	return file_orca_infrafleet_v1_infrafleet_proto_rawDescGZIP(), []int{32}
}

func (x *PickByTagRequest) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
func (x *PickByTagResponse) Reset() {
	*x = PickByTagResponse{}
...
func (x *PickByTagResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PickByTagResponse) ProtoMessage() {}

func (x *PickByTagResponse) ProtoReflect() protoreflect.Message {
	mi := &file_orca_infrafleet_v1_infrafleet_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PickByTagResponse.ProtoReflect.Descriptor instead.
func (*PickByTagResponse) Descriptor() ([]byte, []int) {
	return file_orca_infrafleet_v1_infrafleet_proto_rawDescGZIP(), []int{33}
}

func (x *PickByTagResponse) GetConnectionId() string {
	if x != nil {
		return x.ConnectionId
	}
	return ""
...
const file_orca_infrafleet_v1_infrafleet_proto_rawDesc = "" +
	...
	"\x06groups\x18\x01 \x03(\v2\".orca.infrafleet.v1.DevServerGroupR\x06groups\"$\n" +
	"\x10PickByTagRequest\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\"8\n" +
	"\x11PickByTagResponse\x12#\n" +
	...
	"\x13ListDevServerGroups\x12..orca.infrafleet.v1.ListDevServerGroupsRequest\x1a/.orca.infrafleet.v1.ListDevServerGroupsResponse\x12X\n" +
	"\tPickByTag\x12$.orca.infrafleet.v1.PickByTagRequest\x1a%.orca.infrafleet.v1.PickByTagResponse\x12\x88\x01\n" +
...
var file_orca_infrafleet_v1_infrafleet_proto_goTypes = []any{
	...
	(*PickByTagRequest)(nil),                         // 38: orca.infrafleet.v1.PickByTagRequest
	(*PickByTagResponse)(nil),                        // 39: orca.infrafleet.v1.PickByTagResponse
	(*DevServerGroupGrant)(nil),                      // 40: orca.infrafleet.v1.DevServerGroupGrant
	(*GrantDevServerGroupAccessRequest)(nil),         // 41: orca.infrafleet.v1.GrantDevServerGroupAccessRequest
	(*GrantDevServerGroupAccessResponse)(nil),        // 42: orca.infrafleet.v1.GrantDevServerGroupAccessResponse
	(*RevokeDevServerGroupAccessRequest)(nil),        // 43: orca.infrafleet.v1.RevokeDevServerGroupAccessRequest
	(*RevokeDevServerGroupAccessResponse)(nil),       // 44: orca.infrafleet.v1.RevokeDevServerGroupAccessResponse
	(*ListDevServerGroupGrantsRequest)(nil),          // 45: orca.infrafleet.v1.ListDevServerGroupGrantsRequest
	(*ListDevServerGroupGrantsResponse)(nil),         // 46: orca.infrafleet.v1.ListDevServerGroupGrantsResponse
	(*ListDevServersForUserRequest)(nil),             // 47: orca.infrafleet.v1.ListDevServersForUserRequest
	(*ListDevServersForUserResponse)(nil),            // 48: orca.infrafleet.v1.ListDevServersForUserResponse
	(*DevServerAccessRequest)(nil),                   // 49: orca.infrafleet.v1.DevServerAccessRequest
	(*CreateAccessRequestRequest)(nil),               // 50: orca.infrafleet.v1.CreateAccessRequestRequest
	(*CreateAccessRequestResponse)(nil),              // 51: orca.infrafleet.v1.CreateAccessRequestResponse
	(*ListPendingAccessRequestsRequest)(nil),         // 52: orca.infrafleet.v1.ListPendingAccessRequestsRequest
	(*ListPendingAccessRequestsResponse)(nil),        // 53: orca.infrafleet.v1.ListPendingAccessRequestsResponse
	(*ResolveAccessRequestRequest)(nil),              // 54: orca.infrafleet.v1.ResolveAccessRequestRequest
	(*ResolveAccessRequestResponse)(nil),             // 55: orca.infrafleet.v1.ResolveAccessRequestResponse
	(*CreateConnectionRequest)(nil),                  // 56: orca.infrafleet.v1.CreateConnectionRequest
	(*CreateConnectionResponse)(nil),                 // 57: orca.infrafleet.v1.CreateConnectionResponse
	(*RelayRequest)(nil),                             // 58: orca.infrafleet.v1.RelayRequest
	(*RelayResponse)(nil),                            // 59: orca.infrafleet.v1.RelayResponse
	(*RelayStreamRequest)(nil),                       // 60: orca.infrafleet.v1.RelayStreamRequest
	(*RelayStreamFrame)(nil),                         // 61: orca.infrafleet.v1.RelayStreamFrame
	(*StreamExecOutputRequest)(nil),                  // 62: orca.infrafleet.v1.StreamExecOutputRequest
	(*AgentExecOutputEvent)(nil),                     // 63: orca.infrafleet.v1.AgentExecOutputEvent
	(*RelayByDevServerRequest)(nil),                  // 64: orca.infrafleet.v1.RelayByDevServerRequest
	(*StreamFileChangesRequest)(nil),                 // 65: orca.infrafleet.v1.StreamFileChangesRequest
	(*FileChangeEvent)(nil),                          // 66: orca.infrafleet.v1.FileChangeEvent
	(*IsDevServerConnectedRequest)(nil),              // 67: orca.infrafleet.v1.IsDevServerConnectedRequest
	(*IsDevServerConnectedResponse)(nil),             // 68: orca.infrafleet.v1.IsDevServerConnectedResponse
	(*CreateSshTargetRequest)(nil),                   // 69: orca.infrafleet.v1.CreateSshTargetRequest
	(*CreateSshTargetResponse)(nil),                  // 70: orca.infrafleet.v1.CreateSshTargetResponse
	(*FleetSpecServerProto)(nil),                     // 71: orca.infrafleet.v1.FleetSpecServerProto
	(*BulkProvisionFleetEvent)(nil),                  // 72: orca.infrafleet.v1.BulkProvisionFleetEvent
	(*ApplyTerraformPlanRequest)(nil),                // 73: orca.infrafleet.v1.ApplyTerraformPlanRequest
	(*ProvisionConfigProto)(nil),                     // 74: orca.infrafleet.v1.ProvisionConfigProto
	(*FleetDefinitionProto)(nil),                     // 75: orca.infrafleet.v1.FleetDefinitionProto
	(*CreateFleetDefinitionRequest)(nil),             // 76: orca.infrafleet.v1.CreateFleetDefinitionRequest
	(*UpdateFleetDefinitionRequest)(nil),             // 77: orca.infrafleet.v1.UpdateFleetDefinitionRequest
	(*GetFleetDefinitionRequest)(nil),                // 78: orca.infrafleet.v1.GetFleetDefinitionRequest
	(*ListFleetDefinitionsRequest)(nil),              // 79: orca.infrafleet.v1.ListFleetDefinitionsRequest
	(*ListFleetDefinitionsResponse)(nil),             // 80: orca.infrafleet.v1.ListFleetDefinitionsResponse
	(*ExportFleetDefinitionYamlRequest)(nil),         // 81: orca.infrafleet.v1.ExportFleetDefinitionYamlRequest
	(*ExportFleetDefinitionYamlResponse)(nil),        // 82: orca.infrafleet.v1.ExportFleetDefinitionYamlResponse
	(*DeployFleetDefinitionRequest)(nil),             // 83: orca.infrafleet.v1.DeployFleetDefinitionRequest
	(*ApplyTerraformPlanEvent)(nil),                  // 84: orca.infrafleet.v1.ApplyTerraformPlanEvent
	(*GetFleetHealthRequest)(nil),                    // 85: orca.infrafleet.v1.GetFleetHealthRequest
	(*DevServerHealth)(nil),                          // 86: orca.infrafleet.v1.DevServerHealth
	(*GetFleetHealthResponse)(nil),                   // 87: orca.infrafleet.v1.GetFleetHealthResponse
	(*ScanWorkspacePortsRequest)(nil),                // 88: orca.infrafleet.v1.ScanWorkspacePortsRequest
	(*DetectedPortProto)(nil),                        // 89: orca.infrafleet.v1.DetectedPortProto
	(*ScanWorkspacePortsResponse)(nil),               // 90: orca.infrafleet.v1.ScanWorkspacePortsResponse
	(*KillWorkspacePortRequest)(nil),                 // 91: orca.infrafleet.v1.KillWorkspacePortRequest
	(*PortForward)(nil),                              // 92: orca.infrafleet.v1.PortForward
	(*CreatePortForwardRequest)(nil),                 // 93: orca.infrafleet.v1.CreatePortForwardRequest
	(*ListPortForwardsRequest)(nil),                  // 94: orca.infrafleet.v1.ListPortForwardsRequest
	(*ListPortForwardsResponse)(nil),                 // 95: orca.infrafleet.v1.ListPortForwardsResponse
	(*DeletePortForwardRequest)(nil),                 // 96: orca.infrafleet.v1.DeletePortForwardRequest
	(*StreamPortForwardEventsRequest)(nil),           // 97: orca.infrafleet.v1.StreamPortForwardEventsRequest
	(*PortForwardEvent)(nil),                         // 98: orca.infrafleet.v1.PortForwardEvent
	(*KillWorkspacePortResponse)(nil),                // 99: orca.infrafleet.v1.KillWorkspacePortResponse
	(*SshTarget)(nil),                                // 100: orca.infrafleet.v1.SshTarget
	(*ListSshTargetsRequest)(nil),                    // 101: orca.infrafleet.v1.ListSshTargetsRequest
	(*ListSshTargetsResponse)(nil),                   // 102: orca.infrafleet.v1.ListSshTargetsResponse
	(*GetSshStateRequest)(nil),                       // 103: orca.infrafleet.v1.GetSshStateRequest
	(*GetSshStateResponse)(nil),                      // 104: orca.infrafleet.v1.GetSshStateResponse
	(*EstablishConnectionRequest)(nil),               // 105: orca.infrafleet.v1.EstablishConnectionRequest
	(*Connection)(nil),                               // 106: orca.infrafleet.v1.Connection
	(*GetFleetConnectivitySummaryRequest)(nil),       // 107: orca.infrafleet.v1.GetFleetConnectivitySummaryRequest
	(*ConnectionHealthEntry)(nil),                    // 108: orca.infrafleet.v1.ConnectionHealthEntry
	(*GetFleetConnectivitySummaryResponse)(nil),      // 109: orca.infrafleet.v1.GetFleetConnectivitySummaryResponse
...
var file_orca_infrafleet_v1_infrafleet_proto_depIdxs = []int32{
	...
	40,  // 22: orca.infrafleet.v1.GrantDevServerGroupAccessResponse.grant:type_name -> orca.infrafleet.v1.DevServerGroupGrant
	40,  // 23: orca.infrafleet.v1.ListDevServerGroupGrantsResponse.grants:type_name -> orca.infrafleet.v1.DevServerGroupGrant
	...
	49,  // 29: orca.infrafleet.v1.CreateAccessRequestResponse.request:type_name -> orca.infrafleet.v1.DevServerAccessRequest
	49,  // 30: orca.infrafleet.v1.ListPendingAccessRequestsResponse.requests:type_name -> orca.infrafleet.v1.DevServerAccessRequest
	49,  // 31: orca.infrafleet.v1.ResolveAccessRequestResponse.request:type_name -> orca.infrafleet.v1.DevServerAccessRequest
	40,  // 32: orca.infrafleet.v1.ResolveAccessRequestResponse.grant:type_name -> orca.infrafleet.v1.DevServerGroupGrant
	...
	71,  // 35: orca.infrafleet.v1.FleetDefinitionProto.servers:type_name -> orca.infrafleet.v1.FleetSpecServerProto
	74,  // 36: orca.infrafleet.v1.FleetDefinitionProto.provision:type_name -> orca.infrafleet.v1.ProvisionConfigProto
	71,  // 37: orca.infrafleet.v1.CreateFleetDefinitionRequest.servers:type_name -> orca.infrafleet.v1.FleetSpecServerProto
	74,  // 38: orca.infrafleet.v1.CreateFleetDefinitionRequest.provision:type_name -> orca.infrafleet.v1.ProvisionConfigProto
	71,  // 39: orca.infrafleet.v1.UpdateFleetDefinitionRequest.servers:type_name -> orca.infrafleet.v1.FleetSpecServerProto
	74,  // 40: orca.infrafleet.v1.UpdateFleetDefinitionRequest.provision:type_name -> orca.infrafleet.v1.ProvisionConfigProto
	75,  // 41: orca.infrafleet.v1.ListFleetDefinitionsResponse.definitions:type_name -> orca.infrafleet.v1.FleetDefinitionProto
	86,  // 42: orca.infrafleet.v1.GetFleetHealthResponse.statuses:type_name -> orca.infrafleet.v1.DevServerHealth
	89,  // 43: orca.infrafleet.v1.ScanWorkspacePortsResponse.ports:type_name -> orca.infrafleet.v1.DetectedPortProto
