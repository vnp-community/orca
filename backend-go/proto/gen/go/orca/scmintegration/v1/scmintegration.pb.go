...
const file_orca_scmintegration_v1_scmintegration_proto_rawDesc = "" +
	...
	"\x16capability_unsupported\x18\x02 \x01(\bR\x15capabilityUnsupported\"\x97\x02\n" +
	...
	"\x1bREVIEW_TYPE_REQUEST_CHANGES\x10\x032\xf0(\n" +
...
var file_orca_scmintegration_v1_scmintegration_proto_msgTypes = make([]protoimpl.MessageInfo, 86)
var file_orca_scmintegration_v1_scmintegration_proto_goTypes = []any{
	...
	(*ListPullRequestsRequest)(nil),                // 13: orca.scmintegration.v1.ListPullRequestsRequest
	(*ListPullRequestsResponse)(nil),               // 14: orca.scmintegration.v1.ListPullRequestsResponse
	(*GetRateLimitStatusRequest)(nil),              // 15: orca.scmintegration.v1.GetRateLimitStatusRequest
	(*GetRateLimitStatusResponse)(nil),             // 16: orca.scmintegration.v1.GetRateLimitStatusResponse
	(*GetAuthStatusRequest)(nil),                   // 17: orca.scmintegration.v1.GetAuthStatusRequest
	(*GetAuthStatusResponse)(nil),                  // 18: orca.scmintegration.v1.GetAuthStatusResponse
	(*StartOAuthFlowRequest)(nil),                  // 19: orca.scmintegration.v1.StartOAuthFlowRequest
	(*StartOAuthFlowResponse)(nil),                 // 20: orca.scmintegration.v1.StartOAuthFlowResponse
	(*CompleteOAuthFlowRequest)(nil),               // 21: orca.scmintegration.v1.CompleteOAuthFlowRequest
	(*CompleteOAuthFlowResponse)(nil),              // 22: orca.scmintegration.v1.CompleteOAuthFlowResponse
	(*RevokeAuthRequest)(nil),                      // 23: orca.scmintegration.v1.RevokeAuthRequest
	(*RevokeAuthResponse)(nil),                     // 24: orca.scmintegration.v1.RevokeAuthResponse
	(*MergePullRequestRequest)(nil),                // 25: orca.scmintegration.v1.MergePullRequestRequest
	(*MergePullRequestResponse)(nil),               // 26: orca.scmintegration.v1.MergePullRequestResponse
	(*RequestPullRequestReviewersRequest)(nil),     // 27: orca.scmintegration.v1.RequestPullRequestReviewersRequest
	(*RemovePullRequestReviewersRequest)(nil),      // 28: orca.scmintegration.v1.RemovePullRequestReviewersRequest
	(*SetPullRequestAutoMergeRequest)(nil),         // 29: orca.scmintegration.v1.SetPullRequestAutoMergeRequest
	(*UpdateIssueRequest)(nil),                     // 30: orca.scmintegration.v1.UpdateIssueRequest
	...
	(*PullRequestLifecycleEvent)(nil),              // 82: orca.scmintegration.v1.PullRequestLifecycleEvent
	(*ReceiveWebhookRequest)(nil),                  // 83: orca.scmintegration.v1.ReceiveWebhookRequest
	(*ReceiveWebhookResponse)(nil),                 // 84: orca.scmintegration.v1.ReceiveWebhookResponse
	(*ReviewComment)(nil),                          // 85: orca.scmintegration.v1.ReviewComment
	(*SubmitReviewRequest)(nil),                    // 86: orca.scmintegration.v1.SubmitReviewRequest
	(*Review)(nil),                                 // 87: orca.scmintegration.v1.Review
...
var file_orca_scmintegration_v1_scmintegration_proto_depIdxs = []int32{
	...
	42, // 3: orca.scmintegration.v1.ListIssueCommentsBySlugResponse.comments:type_name -> orca.scmintegration.v1.ProjectComment
	...
	0,  // 8: orca.scmintegration.v1.ListPullRequestsRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	11, // 9: orca.scmintegration.v1.ListPullRequestsResponse.pull_requests:type_name -> orca.scmintegration.v1.PullRequest
	0,  // 10: orca.scmintegration.v1.GetRateLimitStatusRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 11: orca.scmintegration.v1.GetAuthStatusRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 12: orca.scmintegration.v1.StartOAuthFlowRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 13: orca.scmintegration.v1.CompleteOAuthFlowRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 14: orca.scmintegration.v1.RevokeAuthRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 15: orca.scmintegration.v1.MergePullRequestRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	11, // 16: orca.scmintegration.v1.MergePullRequestResponse.pull_request:type_name -> orca.scmintegration.v1.PullRequest
	0,  // 17: orca.scmintegration.v1.RequestPullRequestReviewersRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 18: orca.scmintegration.v1.RemovePullRequestReviewersRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 19: orca.scmintegration.v1.SetPullRequestAutoMergeRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 20: orca.scmintegration.v1.UpdateIssueRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	0,  // 21: orca.scmintegration.v1.GetPullRequestForBranchRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	11, // 22: orca.scmintegration.v1.GetPullRequestForBranchResponse.pull_request:type_name -> orca.scmintegration.v1.PullRequest
	...
	11, // 36: orca.scmintegration.v1.HostedReviewEligibility.existing_pull_request:type_name -> orca.scmintegration.v1.PullRequest
	...
	0,  // 40: orca.scmintegration.v1.SubmitReviewRequest.provider:type_name -> orca.scmintegration.v1.ScmProvider
	1,  // 41: orca.scmintegration.v1.SubmitReviewRequest.review_type:type_name -> orca.scmintegration.v1.ReviewType
	85, // 42: orca.scmintegration.v1.SubmitReviewRequest.comments:type_name -> orca.scmintegration.v1.ReviewComment
	1,  // 43: orca.scmintegration.v1.Review.state:type_name -> orca.scmintegration.v1.ReviewType
	85, // 44: orca.scmintegration.v1.Review.comments:type_name -> orca.scmintegration.v1.ReviewComment
	4,  // 45: orca.scmintegration.v1.ScmIntegrationService.ListIssues:input_type -> orca.scmintegration.v1.ListIssuesRequest
	6,  // 46: orca.scmintegration.v1.ScmIntegrationService.ListIssueCommentsBySlug:input_type -> orca.scmintegration.v1.ListIssueCommentsBySlugRequest
	8,  // 47: orca.scmintegration.v1.ScmIntegrationService.GetLinkedPullRequestsForIssue:input_type -> orca.scmintegration.v1.GetLinkedPullRequestsForIssueRequest
	10, // 48: orca.scmintegration.v1.ScmIntegrationService.CreatePullRequest:input_type -> orca.scmintegration.v1.CreatePullRequestRequest
	13, // 49: orca.scmintegration.v1.ScmIntegrationService.ListPullRequests:input_type -> orca.scmintegration.v1.ListPullRequestsRequest
	15, // 50: orca.scmintegration.v1.ScmIntegrationService.GetRateLimitStatus:input_type -> orca.scmintegration.v1.GetRateLimitStatusRequest
	17, // 51: orca.scmintegration.v1.ScmIntegrationService.GetAuthStatus:input_type -> orca.scmintegration.v1.GetAuthStatusRequest
	19, // 52: orca.scmintegration.v1.ScmIntegrationService.StartOAuthFlow:input_type -> orca.scmintegration.v1.StartOAuthFlowRequest
	21, // 53: orca.scmintegration.v1.ScmIntegrationService.CompleteOAuthFlow:input_type -> orca.scmintegration.v1.CompleteOAuthFlowRequest
	23, // 54: orca.scmintegration.v1.ScmIntegrationService.RevokeAuth:input_type -> orca.scmintegration.v1.RevokeAuthRequest
	25, // 55: orca.scmintegration.v1.ScmIntegrationService.MergePullRequest:input_type -> orca.scmintegration.v1.MergePullRequestRequest
	27, // 56: orca.scmintegration.v1.ScmIntegrationService.RequestPullRequestReviewers:input_type -> orca.scmintegration.v1.RequestPullRequestReviewersRequest
	28, // 57: orca.scmintegration.v1.ScmIntegrationService.RemovePullRequestReviewers:input_type -> orca.scmintegration.v1.RemovePullRequestReviewersRequest
	29, // 58: orca.scmintegration.v1.ScmIntegrationService.SetPullRequestAutoMerge:input_type -> orca.scmintegration.v1.SetPullRequestAutoMergeRequest
	30, // 59: orca.scmintegration.v1.ScmIntegrationService.UpdateIssue:input_type -> orca.scmintegration.v1.UpdateIssueRequest
	31, // 60: orca.scmintegration.v1.ScmIntegrationService.GetPullRequestForBranch:input_type -> orca.scmintegration.v1.GetPullRequestForBranchRequest
	33, // 61: orca.scmintegration.v1.ScmIntegrationService.ResolveRepoSlug:input_type -> orca.scmintegration.v1.ResolveRepoSlugRequest
	44, // 62: orca.scmintegration.v1.ScmIntegrationService.ListAccessibleProjects:input_type -> orca.scmintegration.v1.ListAccessibleProjectsRequest
	46, // 63: orca.scmintegration.v1.ScmIntegrationService.ResolveProjectRef:input_type -> orca.scmintegration.v1.ResolveProjectRefRequest
	48, // 64: orca.scmintegration.v1.ScmIntegrationService.ListProjectViews:input_type -> orca.scmintegration.v1.ListProjectViewsRequest
	50, // 65: orca.scmintegration.v1.ScmIntegrationService.ViewProjectTable:input_type -> orca.scmintegration.v1.ViewProjectTableRequest
	52, // 66: orca.scmintegration.v1.ScmIntegrationService.UpdateProjectItemField:input_type -> orca.scmintegration.v1.UpdateProjectItemFieldRequest
	53, // 67: orca.scmintegration.v1.ScmIntegrationService.ClearProjectItemField:input_type -> orca.scmintegration.v1.ClearProjectItemFieldRequest
	54, // 68: orca.scmintegration.v1.ScmIntegrationService.GetWorkItemDetailsBySlug:input_type -> orca.scmintegration.v1.GetWorkItemDetailsBySlugRequest
	55, // 69: orca.scmintegration.v1.ScmIntegrationService.UpdateIssueBySlug:input_type -> orca.scmintegration.v1.UpdateIssueBySlugRequest
	56, // 70: orca.scmintegration.v1.ScmIntegrationService.UpdatePullRequestBySlug:input_type -> orca.scmintegration.v1.UpdatePullRequestBySlugRequest
	57, // 71: orca.scmintegration.v1.ScmIntegrationService.UpdateIssueTypeBySlug:input_type -> orca.scmintegration.v1.UpdateIssueTypeBySlugRequest
	58, // 72: orca.scmintegration.v1.ScmIntegrationService.ListIssueTypesBySlug:input_type -> orca.scmintegration.v1.ListIssueTypesBySlugRequest
	60, // 73: orca.scmintegration.v1.ScmIntegrationService.ListAssignableUsersBySlug:input_type -> orca.scmintegration.v1.ListAssignableUsersBySlugRequest
	62, // 74: orca.scmintegration.v1.ScmIntegrationService.ListLabelsBySlug:input_type -> orca.scmintegration.v1.ListLabelsBySlugRequest
	64, // 75: orca.scmintegration.v1.ScmIntegrationService.AddIssueCommentBySlug:input_type -> orca.scmintegration.v1.AddIssueCommentBySlugRequest
	65, // 76: orca.scmintegration.v1.ScmIntegrationService.UpdateIssueCommentBySlug:input_type -> orca.scmintegration.v1.UpdateIssueCommentBySlugRequest
	66, // 77: orca.scmintegration.v1.ScmIntegrationService.DeleteIssueCommentBySlug:input_type -> orca.scmintegration.v1.DeleteIssueCommentBySlugRequest
	68, // 78: orca.scmintegration.v1.ScmIntegrationService.ListMergeRequests:input_type -> orca.scmintegration.v1.ListMergeRequestsRequest
	71, // 79: orca.scmintegration.v1.ScmIntegrationService.ResolveMergeRequestDiscussion:input_type -> orca.scmintegration.v1.ResolveMergeRequestDiscussionRequest
	72, // 80: orca.scmintegration.v1.ScmIntegrationService.GetWorkItemDetails:input_type -> orca.scmintegration.v1.GetWorkItemDetailsRequest
	74, // 81: orca.scmintegration.v1.ScmIntegrationService.CheckHostedReviewEligibility:input_type -> orca.scmintegration.v1.CheckHostedReviewEligibilityRequest
	76, // 82: orca.scmintegration.v1.ScmIntegrationService.SetIntegrationCredential:input_type -> orca.scmintegration.v1.SetIntegrationCredentialRequest
	78, // 83: orca.scmintegration.v1.ScmIntegrationService.GetIntegrationCredentialStatus:input_type -> orca.scmintegration.v1.GetIntegrationCredentialStatusRequest
	80, // 84: orca.scmintegration.v1.ScmIntegrationService.ListIntegrationCredentials:input_type -> orca.scmintegration.v1.ListIntegrationCredentialsRequest
	83, // 85: orca.scmintegration.v1.ScmIntegrationService.ReceiveWebhook:input_type -> orca.scmintegration.v1.ReceiveWebhookRequest
	86, // 86: orca.scmintegration.v1.ScmIntegrationService.SubmitReview:input_type -> orca.scmintegration.v1.SubmitReviewRequest
	5,  // 87: orca.scmintegration.v1.ScmIntegrationService.ListIssues:output_type -> orca.scmintegration.v1.ListIssuesResponse
	7,  // 88: orca.scmintegration.v1.ScmIntegrationService.ListIssueCommentsBySlug:output_type -> orca.scmintegration.v1.ListIssueCommentsBySlugResponse
	9,  // 89: orca.scmintegration.v1.ScmIntegrationService.GetLinkedPullRequestsForIssue:output_type -> orca.scmintegration.v1.GetLinkedPullRequestsForIssueResponse
	12, // 90: orca.scmintegration.v1.ScmIntegrationService.CreatePullRequest:output_type -> orca.scmintegration.v1.CreatePullRequestResponse
	14, // 91: orca.scmintegration.v1.ScmIntegrationService.ListPullRequests:output_type -> orca.scmintegration.v1.ListPullRequestsResponse
	16, // 92: orca.scmintegration.v1.ScmIntegrationService.GetRateLimitStatus:output_type -> orca.scmintegration.v1.GetRateLimitStatusResponse
	18, // 93: orca.scmintegration.v1.ScmIntegrationService.GetAuthStatus:output_type -> orca.scmintegration.v1.GetAuthStatusResponse
	20, // 94: orca.scmintegration.v1.ScmIntegrationService.StartOAuthFlow:output_type -> orca.scmintegration.v1.StartOAuthFlowResponse
	22, // 95: orca.scmintegration.v1.ScmIntegrationService.CompleteOAuthFlow:output_type -> orca.scmintegration.v1.CompleteOAuthFlowResponse
	24, // 96: orca.scmintegration.v1.ScmIntegrationService.RevokeAuth:output_type -> orca.scmintegration.v1.RevokeAuthResponse
	26, // 97: orca.scmintegration.v1.ScmIntegrationService.MergePullRequest:output_type -> orca.scmintegration.v1.MergePullRequestResponse
	11, // 98: orca.scmintegration.v1.ScmIntegrationService.RequestPullRequestReviewers:output_type -> orca.scmintegration.v1.PullRequest
	11, // 99: orca.scmintegration.v1.ScmIntegrationService.RemovePullRequestReviewers:output_type -> orca.scmintegration.v1.PullRequest
	11, // 100: orca.scmintegration.v1.ScmIntegrationService.SetPullRequestAutoMerge:output_type -> orca.scmintegration.v1.PullRequest
	2,  // 101: orca.scmintegration.v1.ScmIntegrationService.UpdateIssue:output_type -> orca.scmintegration.v1.Issue
	32, // 102: orca.scmintegration.v1.ScmIntegrationService.GetPullRequestForBranch:output_type -> orca.scmintegration.v1.GetPullRequestForBranchResponse
	34, // 103: orca.scmintegration.v1.ScmIntegrationService.ResolveRepoSlug:output_type -> orca.scmintegration.v1.ResolveRepoSlugResponse
	45, // 104: orca.scmintegration.v1.ScmIntegrationService.ListAccessibleProjects:output_type -> orca.scmintegration.v1.ListAccessibleProjectsResponse
	47, // 105: orca.scmintegration.v1.ScmIntegrationService.ResolveProjectRef:output_type -> orca.scmintegration.v1.ResolveProjectRefResponse
	49, // 106: orca.scmintegration.v1.ScmIntegrationService.ListProjectViews:output_type -> orca.scmintegration.v1.ListProjectViewsResponse
	51, // 107: orca.scmintegration.v1.ScmIntegrationService.ViewProjectTable:output_type -> orca.scmintegration.v1.ViewProjectTableResponse
	36, // 108: orca.scmintegration.v1.ScmIntegrationService.UpdateProjectItemField:output_type -> orca.scmintegration.v1.ProjectItem
	36, // 109: orca.scmintegration.v1.ScmIntegrationService.ClearProjectItemField:output_type -> orca.scmintegration.v1.ProjectItem
	43, // 110: orca.scmintegration.v1.ScmIntegrationService.GetWorkItemDetailsBySlug:output_type -> orca.scmintegration.v1.WorkItemDetails
	43, // 111: orca.scmintegration.v1.ScmIntegrationService.UpdateIssueBySlug:output_type -> orca.scmintegration.v1.WorkItemDetails
	43, // 112: orca.scmintegration.v1.ScmIntegrationService.UpdatePullRequestBySlug:output_type -> orca.scmintegration.v1.WorkItemDetails
	43, // 113: orca.scmintegration.v1.ScmIntegrationService.UpdateIssueTypeBySlug:output_type -> orca.scmintegration.v1.WorkItemDetails
	59, // 114: orca.scmintegration.v1.ScmIntegrationService.ListIssueTypesBySlug:output_type -> orca.scmintegration.v1.ListIssueTypesBySlugResponse
	61, // 115: orca.scmintegration.v1.ScmIntegrationService.ListAssignableUsersBySlug:output_type -> orca.scmintegration.v1.ListAssignableUsersBySlugResponse
	63, // 116: orca.scmintegration.v1.ScmIntegrationService.ListLabelsBySlug:output_type -> orca.scmintegration.v1.ListLabelsBySlugResponse
	42, // 117: orca.scmintegration.v1.ScmIntegrationService.AddIssueCommentBySlug:output_type -> orca.scmintegration.v1.ProjectComment
	42, // 118: orca.scmintegration.v1.ScmIntegrationService.UpdateIssueCommentBySlug:output_type -> orca.scmintegration.v1.ProjectComment
	88, // 119: orca.scmintegration.v1.ScmIntegrationService.DeleteIssueCommentBySlug:output_type -> google.protobuf.Empty
	69, // 120: orca.scmintegration.v1.ScmIntegrationService.ListMergeRequests:output_type -> orca.scmintegration.v1.ListMergeRequestsResponse
	70, // 121: orca.scmintegration.v1.ScmIntegrationService.ResolveMergeRequestDiscussion:output_type -> orca.scmintegration.v1.MergeRequestDiscussion
	73, // 122: orca.scmintegration.v1.ScmIntegrationService.GetWorkItemDetails:output_type -> orca.scmintegration.v1.WorkItemDetailsGitLab
	75, // 123: orca.scmintegration.v1.ScmIntegrationService.CheckHostedReviewEligibility:output_type -> orca.scmintegration.v1.HostedReviewEligibility
	77, // 124: orca.scmintegration.v1.ScmIntegrationService.SetIntegrationCredential:output_type -> orca.scmintegration.v1.SetIntegrationCredentialResponse
	79, // 125: orca.scmintegration.v1.ScmIntegrationService.GetIntegrationCredentialStatus:output_type -> orca.scmintegration.v1.GetIntegrationCredentialStatusResponse
	81, // 126: orca.scmintegration.v1.ScmIntegrationService.ListIntegrationCredentials:output_type -> orca.scmintegration.v1.ListIntegrationCredentialsResponse
	84, // 127: orca.scmintegration.v1.ScmIntegrationService.ReceiveWebhook:output_type -> orca.scmintegration.v1.ReceiveWebhookResponse
	87, // 128: orca.scmintegration.v1.ScmIntegrationService.SubmitReview:output_type -> orca.scmintegration.v1.Review
...
func file_orca_scmintegration_v1_scmintegration_proto_init() {
	...
	file_orca_scmintegration_v1_scmintegration_proto_msgTypes[28].OneofWrappers = []any{}
	file_orca_scmintegration_v1_scmintegration_proto_msgTypes[53].OneofWrappers = []any{}
