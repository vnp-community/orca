import { stripLeadingAgentTitleDecorationOrEmpty } from '../vendor-shared/shared/agent-title-decoration'
import { resolveExplicitTerminalTitleAgentType } from '../vendor-shared/shared/terminal-title-agent-type'
